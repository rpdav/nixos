...
{ pkgs, lib, uptix, secrets, serviceOpts, systemOpts, ... }:

{
  ...
  virtualisation.oci-containers.containers."dms" = {
    ...
    volumes = [
      ...
      "${serviceOpts.dockerDir}/dms/config/:/tmp/docker-mailserver:rw"
      "${serviceOpts.dockerDir}/dms/mail-data/:/var/mail:rw"
      "${serviceOpts.dockerDir}/dms/mail-logs/:/var/log/mail:rw"
      "${serviceOpts.dockerDir}/dms/mail-state/:/var/mail-state:rw"
